            ...
            <template v-slot:header>
              <div class="bg-white border-0">
                <div class="row align-items-center">
                  ...
                  <modal
                    v-model:show="modals.showAddExperienceModal"
                    body-classes="p-0"
                    ...
                    >
                          ...
                          <div class="row">
                            <div class="col-md-9">
                              <base-input
                                alternative=""
                                label="Position"
                                placeholder="What was your role / function?"
                                input-classes="form-control-alternative"
                                v-model:value="addExperienceModel.position"
                              />
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-lg-5">
                              <base-input
                                ...
                                placeholder="Company"
                                input-classes="form-control-alternative"
                                v-model:value="addExperienceModel.company"
                              />
                            </div>
                            <div class="col-lg-3">
                              <base-input
                                ...
                                placeholder="Country"
                                input-classes="form-control-alternative"
                                v-model:value="addExperienceModel.country"
                              />
                            </div>
                            <div class="col-lg-2">
                              <base-input
                                ...
                                input-classes="form-control-alternative"
                                v-model:value="addExperienceModel.startDate"
                              />
                            </div>
                            <div class="col-lg-2">
                              <base-input
                                ...
                                input-classes="form-control-alternative"
                                v-model:value="addExperienceModel.endDate"
                              />
                            </div>
                          </div>
                          <div class="row">
                            ...
                            <div class="col-lg-12">
                              <div class="form-group">
                                <base-input alternative="" label="Description">
                                  <textarea
                                    rows="4"
                                    v-model="addExperienceModel.description"
                      ...
                      <template v-slot:footer>
                        <div class="">
                          <base-button
                            type="warning"
                            @click="modals.showAddExperienceModal = false"
                            class="my-1"
                          >
                            Close
                          </base-button>
                  ...
                  <modal
                    v-model:show="modals.showEditExperienceModal"
                    body-classes="p-0"
                    modal-classes="modal-dialog-centered modal-lg"
                  >
                    <card
                    ...
                    >
                          ...
                          <div class="row">
                            <div class="col-sm-9">
                              <base-input
                                ...
                                placeholder="What was your role / function?"
                                input-classes="form-control-alternative"
                                v-model:value="editExperienceModel.position"
                              />
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-lg-5">
                              <base-input
                                ...
                                placeholder="Company"
                                input-classes="form-control-alternative"
                                v-model:value="editExperienceModel.company"
                              />
                            </div>
                            <div class="col-lg-3 col-sm-6">
                              <base-input
                                ...
                                placeholder="Country"
                                input-classes="form-control-alternative"
                                v-model:value="editExperienceModel.country"
                              />
                            </div>
                            <div class="col-lg-2 col-sm-3">
                              <base-input
                                ...
                                placeholder="Start Date"
                                input-classes="form-control-alternative"
                                v-model:value="editExperienceModel.startDate"
                              />
                            </div>
                            <div class="col-lg-2 col-sm-3">
                              <base-input
                                ...
                                placeholder="End Date"
                                input-classes="form-control-alternative"
                                v-model:value="editExperienceModel.endDate"
                              />
                            </div>
                          </div>
                          <div class="row">
                            ...
                            <div class="col-lg-12">
                              <div class="form-group">
                                <base-input alternative="" label="Description">
                                  <textarea
                                    rows="4"
                                    v-model="editExperienceModel.description"
                                    class="form-control form-control-alternative"
                                    placeholder="Describe your experience With a focus on the skills you gained ..."
                                  ></textarea>
                                </base-input>
                              </div>
                            </div>
                      ...
                      <template v-slot:footer>
                        <div class="">
                          <base-button
                            type="warning"
                            @click="modals.showEditExperienceModal = false"
                            class="my-1"
                          >
                            Close
                          </base-button>
                          <base-button
                            type="info"
                            @click="editExperience(deleteIndex)"
                            class="my-1 float-right"
                          >
                            Save
                          </base-button>
                  ...
                  <modal
                    ...
                    v-model:show="modals.showDeleteExperienceModal"
                    gradient="danger"
                  ...
                  >
                    ...
                    <template v-slot:footer>
                      ...
                      <base-button
                        ...
                        text-color="info"
                        class="ml-auto"
                        @click="modals.showDeleteExperienceModal = false"
                      >
                        Close
                      </base-button>
                    </template>
                  ...
                  <div class="col-4 text-right">
                    <a
                      href="/profile"
                      @click.prevent="modals.showAddExperienceModal = true"
...
export default {
  ...
  methods: {
    ...
    editExperience(index) {
      ExperienceService.saveExperience(this.editExperienceModel, index).then(
        () => {
