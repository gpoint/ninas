...
<div class="content">
        ...
        <div>
            <card class="no-border-card" body-classes="px-0 pb-1" footer-classes="pb-2">
                ...
                <div class="px-3">
                    ...
                    <form class="row col-12 text-right">
                        <div class="col-md-5"></div>
                        <div class="col-md-5">
                            <base-input placeholder="Search Scope/Standard" input-classes="form-control-alternative" v-model:value="searchText"></base-input>
                        </div>
                        <div class="col-md-2">
                            <base-button native-type="submit" type="primary">Search</base-button>
                        </div>
                    </form>
                    <el-table :data="queriedData" row-key="id" header-row-class-name="thead-light">
                        ...
                        <el-table-column width="0px" min-width="0px" max-width="0px" align="left" label="">
                        ...
                        <el-table-column min-width="80px" align="left" label="Actions">
                            <template v-slot:default="props">
                                <div class="d-flex">
                                    <base-button @click="handleView(props.$index, props.row)" class="like btn-link" type="default" size="sm" icon>
    ...
    <modal v-model:show="modals.showUserModal" body-classes="p-0" modal-classes="modal-dialog-centered modal-lg">
        <card type="secondary" shadow header-classes="bg-white pb-5" body-classes="px-lg-5 py-lg-4" class="border-0">
                                    ...
                                    <form>
                                        ...
                                        <div class="pl-lg-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <base-input alternative="" label="Resident State" :readonly="true" input-classes="form-control-alternative" :value="modals.row.stateOfOrigin" />
                                                </div>
                                            </div>
                                        </div>
                                        <hr class="my-4" />
                                    ...
                                    <div v-for="(edu, index) in modals.row.education" :key="index">
                                        <div class="pl-2 mt--2">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    {{ edu.school }},
                                                    <strong> {{ edu.country }} </strong>
                                                    <badge type="success" class="float-right" v-if="edu.currentlyStudying">
                                                        Present
                                                    </badge>
                                                </div>
                                                <strong class="col-12 heading-small text-left">{{ "From: " + getDate(edu.startDate) }} - {{ "" + getDate(edu.endDate) }}</strong>
                                            </div>
                                    ...
                                    <div v-for="(exp, index) in modals.row.experience" :key="index">
                                        <div class="pl-2 mt--2">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    {{ exp.company }},
                                                    <strong> {{ exp.country }} </strong>
                                                    <badge type="success" class="float-right" v-if="exp.currentlyWorking">
                                                        Present
                                                    </badge>
                                                </div>
                                                <strong class="col-12 heading-small text-left">{{ "From: " + getDate(exp.startDate) }} - {{ "" + getDate(exp.endDate) }}</strong>
                                            </div>
                                            <hr class="mt-0 mb-4" style="border:solid 2px darkgreen;">
                                        </div>
                                    </div>
            ...
            <template v-slot:footer>
                <div class="">
                    <base-button type="info" @click="modals.showUserModal = false" class="my-1 float-right">
                        Close
                    </base-button>
                </div>
            </template>
...
export default {
    ...
    data() {
        return {
            ...
            searchQuery: "",
            propsToSearch: ["firstname", "lastname", "email", "education", ],
            tableColumns: [{
                    prop: "firstName",
                    label: "First name",
                    minWidth: 125,
