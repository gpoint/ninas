            ...
            <card class="no-border-card" body-classes="px-0 pb-1" footer-classes="pb-2">
                ...
                <div class="px-3">
                    <div class="col-12 d-flex justify-content-center justify-content-sm-between flex-wrap">
                        ...
                        <div>
                            <el-input type="search" class="mb-3" clearable prefix-icon="el-icon-search" style="width: 200px" placeholder="Search Records" v-model="searchQuery" aria-controls="datatables">
                            </el-input>
                        </div>
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            searchQuery: "",
            propsToSearch: ["name", "email", "education", "experience", "portfolio"],
            tableColumns: [{
                    prop: "name",
                    label: "Name",
                    minWidth: 125,
    ...
    mounted() {
        AdminService.getAssessors().then((response) => {
