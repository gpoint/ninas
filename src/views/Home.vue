<template>
  <div class="home">
  	<section class="hero-section set-bg" :style="`background-image: url(${require('@/assets/img/bg.jpg')});`">
	...
	<section class="properties-section spad">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="propertie-item set-bg" :style="`background-image: url(${require('@/assets/img/propertie/1.jpg')});`">
				...
				<div class="col-md-6">
					<div class="propertie-item set-bg" :style="`background-image: url(${require('@/assets/img/propertie/2.jpg')});`">
				...
				<div class="col-md-6">
					<div class="propertie-item set-bg" :style="`background-image: url(${require('@/assets/img/propertie/3.jpg')});`">
						<div class="sale-notic">FOR SALE</div>
						<div class="propertie-info text-white">
							<div class="info-warp">
				...
				<div class="col-md-6">
					<div class="propertie-item set-bg" :style="`background-image: url(${require('@/assets/img/propertie/4.jpg')});`">
						<div class="rent-notic">FOR Rent</div>
						<div class="propertie-info text-white">
							<div class="info-warp">
	...
	<!-- Services section -->
	<section class="services-section spad set-bg" :style="`background-image: url(${require('@/assets/img/service-bg.jpg')});`">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
	...
	<section class="gallery-section spad">
		<div class="container">
			...
			<div class="gallery">
				...
				<a href="#" class="gallery-item grid-long set-bg" :style="`background-image: url(${require('@/assets/img/gallery/1.jpg')});`">
					<div class="gi-info">
						<h3>New York</h3>
						<p>118 Properties</p>
					</div>
				</a>
				<a href="#" class="gallery-item grid-wide set-bg" :style="`background-image: url(${require('@/assets/img/gallery/2.jpg')});`">
					<div class="gi-info">
						<h3>Florida</h3>
						<p>112 Properties</p>
					</div>
				</a>
				<a href="#" class="gallery-item set-bg" :style="`background-image: url(${require('@/assets/img/gallery/3.jpg')});`">
					<div class="gi-info">
						<h3>San Jose</h3>
						<p>72 Properties</p>
					</div>
				</a>
				<a href="#" class="gallery-item set-bg" :style="`background-image: url(${require('@/assets/img/gallery/4.jpg')});`">
					<div class="gi-info">
						<h3>St Louis</h3>
						<p>50 Properties</p>
					</div>
	...
	<!-- Review section -->
	<section class="review-section set-bg" :style="`background-image: url(${require('@/assets/img/review-bg.jpg')});`">
		<div class="container">
			<div class="review-slider owl-carousel">
				<div class="review-item text-white">
					...
					<div class="clint-pic set-bg" :style="`background-image: url(${require('@/assets/img/review/1.jpg')});`"></div>
				</div>
				<div class="review-item text-white">
					<div class="rating">
						<i class="fa fa-star"></i>
