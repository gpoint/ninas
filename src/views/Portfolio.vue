            ...
            <template v-slot:header>
              <div class="bg-white border-0">
                <div class="row align-items-center">
                  ...
                  <modal
                    v-model:show="modals.showAddPortfolioModal"
                    body-classes="p-0"
                      ...
                      >
                          ...
                          <div class="">
                            <div class="row">
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <select
                                    ...
                                    v-model="addPortfolioModel.standard"
                                    style="width: 100%"
                                  >
                                    <option
                                      v-for="(option, index) in standards"
                                      :key="index"
                                      :value="index"
                                    >
                                      {{ option.value }}
                              ...
                              <div class="col-md-9">
                                <div class="form-group">
                                  <label
                                    v-if="addPortfolioModel.standard == null"
                                  ...
                                  <input
                                    ...
                                    required
                                    class="form-control form-control-alternative"
                                    v-model="addPortfolioModel.scope"
                                  />
                                  <select
                                    v-if="
                                      addPortfolioModel.standard != null &&
                              ...
                              <div class="col-lg-12">
                                <div class="form-group">
                                  ...
                                  >
                                    <textarea
                                      rows="4"
                                      v-model="addPortfolioModel.description"
                                      class="form-control form-control-alternative"
                                      placeholder="Describe your competence within your scope and detail your subscopes ..."
                                    ></textarea>
                                  </base-input>
                                </div>
                              </div>
                        ...
                        <template v-slot:footer>
                          <div class="">
                            <base-button
                              type="warning"
                              @click="modals.showAddPortfolioModal = false"
                              class="my-1"
                            >
                              Close
                            </base-button>
                  ...
                  <modal
                    ...
                    v-model:show="modals.showDeletePortfolioModal"
                    gradient="danger"
                  ...
                  >
                    ...
                    <template v-slot:footer>
                      ...
                      <base-button
                        ...
                        text-color="info"
                        class="ml-auto"
                        @click="modals.showDeletePortfolioModal = false"
                      >
                        Close
                      </base-button>
                    </template>
                  ...
                  <div class="col-4 text-right">
                    <a
                      href="/profile"
                      @click.prevent="modals.showAddPortfolioModal = true"
