                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <select
                        class="form-control-alternative form-control"
                        v-model="model.stateOfResidence"
                        style="width: 100%"
                      >
                        <option
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        style="width: 100%"
                      >
                        <option v-for="year in 20" :key="year" :value="year">
                          {{ year }}
                        </option>
                      </select>
                    </div>
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      >
                        <option
                          :value="
                            'Artisan Of The Year ( ' + model.gender + ' )'
                          "
                          v-if="model.gender != null && model.gender != ''"
                        >
                          Artisan Of The Year ( {{ model.gender }} )
                        </option>
                        <option
                          :value="model.trade + ' Of The Year'"
                          v-if="model.trade != null && model.trade != ''"
                        >
                          {{ model.trade }} Of The Year
                        </option>
                    ...
                    <div class="form-group">
                      <base-input alternative="" label="About Me">
                        <textarea
                          ...
                          placeholder="A few words about why you should receive the award ..."
                        ></textarea>
                      </base-input>
                    </div>
                  </div>
