                    ...
                    <template v-slot:header>
                        <div class="bg-white border-0">
                            <div class="row align-items-center">
                                ...
                                <modal v-model:show="modals.showAddEducationModal" body-classes="p-0" modal-classes="modal-dialog-centered modal-lg">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control form-control-alternative" v-model="addEducationModel.degree" style="width: 100%">
                                                    ...
                                                    <div class="col-md-9">
                                                        <base-input alternative="" label="Course" placeholder="What did you study in school?" input-classes="form-control-alternative" v-model:value="addEducationModel.course" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-5">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <base-input alternative="" type="date" label="End Date" placeholder="End Date" input-classes="form-control-alternative" v-model:value="addEducationModel.endDate" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                ...
                                " class="custom-control-alternative">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <base-input alternative="" label="Description">
                                                                <textarea rows="4" v-model="addEducationModel.description" class="form-control form-control-alternative" placeholder="Describe your education With a focus on the skills you gained ..."></textarea>
                                                            </base-input>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <template v-slot:footer>
                                            <div class="">
                                                <base-button type="warning" @click="modals.showAddEducationModal = false" class="my-1">
                                                    Close
                                                </base-button>
                                                <base-button type="info" @click="addEducation" class="my-1 float-right">
                                                    Save
                                                </base-button>
                                            </div>
                                        </template>
                                ...
                                <modal v-model:show="modals.showEditEducationModal" body-classes="p-0" modal-classes="modal-dialog-centered modal-lg">
                                    <card type="secondary" shadow header-classes="bg-white pb-5" body-classes="px-lg-5 py-lg-4" class="border-0">
                                        <template v-slot:header>
                                            <div class="text-muted text-left mb--5">
                                                <h3>Add Education</h3>
                                            ...
                                            <div class="">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label class="form-control-label">Degree</label>
                                                            <select class="form-control form-control-alternative" v-model="editEducationModel.degree" style="width: 100%">
                                                                <option v-for="option in degreeOptions" :key="option" :value="option">
                                                                    {{ option }}
                                                                </option>
                                                            </select>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <base-input alternative="" label="Course" placeholder="What did you study in school?" input-classes="form-control-alternative" v-model:value="editEducationModel.course" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-5">
                                                    ...
                                                    <div class="col-lg-2 col-sm-3">
                                                        <base-input alternative="" type="date" label="End Date" placeholder="End Date" input-classes="form-control-alternative" v-model:value="editEducationModel.endDate" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-12 mb-3">
                                ...
                                " class="custom-control-alternative">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <base-input alternative="" label="Description">
                                                                <textarea rows="4" v-model="editEducationModel.description" class="form-control form-control-alternative" placeholder="Describe your education With a focus on the skills you gained ..."></textarea>
                                                            </base-input>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <template v-slot:footer>
                                            <div class="">
                                                <base-button type="warning" @click="modals.showEditEducationModal = false" class="my-1">
                                                    Close
                                                </base-button>
                                                <base-button type="info" @click="editEducation" class="my-1 float-right">
                                                    Save
                                                </base-button>
                                            </div>
                                        </template>
                                ...
                                <modal v-model:show="modals.showDeleteEducationModal" gradient="danger" modal-classes="modal-danger modal-dialog-centered">
                                    <template v-slot:header>
                                        ...
                                        <div class="pl-2 mt--2">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <badge type="white" class="float-right" v-if="deleteEducationModel.currentlyStudying">
                                ...
                                <div class="col-4 text-right">
                                    <a href="/profile" @click.prevent="modals.showAddEducationModal = true" class="btn btn-sm btn-success">
                                        ...
                                        <div class="pl-2 mt--2">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <badge type="success" class="float-right" v-if="education.currentlyStudying">
                                                        Present
                                                    </badge>
                                                </div>
                                            </div>
...
export default {
    ...
    methods: {
        ...
        editEducation() {
            EducationService.saveEducation(this.editEducationModel, this.deleteIndex).then(
                () => {
        ...
        deleteEducation() {
            EducationService.deleteEducation(this.deleteIndex).then(() => {
                EducationService.getEducationList().then((response) => {
                    this.setEducationList(response.data.result);
                });
                return 1;
